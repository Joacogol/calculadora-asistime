  ...
  if (!foto) {
    return {
      ...
      message:
        ...
        "arrancar. Usá una que hayan mandado en el chat, o armá la de partida " +
        "con `crear_foto` (100 créditos) — mostrásela antes, porque si no le " +
        "gusta se pierde también el video. Si el video muestra un PRODUCTO, la " +
